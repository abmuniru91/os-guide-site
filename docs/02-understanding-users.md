...
## 2.1 What UI/UX Means, in Practice

Two terms recur throughout this guide and are worth defining plainly before going further.

**User Interface (UI)** refers to the visual and interactive elements of a product — the screens, buttons, text, icons, and layout a person actually touches and sees.

**User Experience (UX)** refers to the overall quality of a person's interaction with a product: how easy, intuitive, and satisfying it feels to accomplish what they came to do. UX is broader than UI — it includes onboarding, support, trust, and how a product fits into someone's daily routine, not just how a screen looks.

In practice the two are inseparable. A beautifully designed screen (good UI) that requires five taps to record one sale (poor UX) will still be abandoned by a busy trader. This guide treats UI and UX together, and treats "gender-responsive design" not as designing specifically for women, but as designing in ways that are actively aware of and responsive to how gender shapes technology use, access, and trust.

## 2.2 The Ghanaian Context: Who the Users Are

Any meaningful work in this space starts with an honest picture of who the users are and what their daily lives look like. This section draws on participant profiles, field observations, and research findings gathered across all DTEG project partnerships.

Women micro-entrepreneurs in peri-urban and rural Ghana are not a homogeneous group. They range from young women running digital-forward retail businesses in Tamale to older traders who have managed market stalls for decades using notebook records and informal networks. They include differently-abled entrepreneurs, smallholder farmers, food processors, hairdressers, tailors, fabric sellers, and agricultural traders. What they share is that most digital solutions were built without any of them in mind.

Critically, the goal of user research in this space is not to produce a "typical female user" profile. The aim is to develop multi-dimensional, intersectional personas that reflect age, geography, caregiving roles, literacy level, digital experience, language, and sector. A one-dimensional profile creates one-dimensional solutions. (Sample composite personas built from DTEG participant data are provided in Section 6.3.)

**Explore the DTEG cohort.** The schematic below mirrors the regional summary introduced in Section 1.3 (north to south, not to scale) — click a region to see its intermediary and solution count, and to filter the table beneath it to that region.

<div id="dteg-region-locator"></div>

**Solutions at a glance.** The table below summarizes all thirty solutions tested or incubated across both phases of the DTEG project — a reference point for the case studies referenced throughout this guide. Solutions S1–S11 and P1–P7 carry full field validation evidence (quotes, task-completion data); S12–S18 and P8–P12 are newer additions to this edition, documented at roster level only. Use the search box, filters, and column headers below to find a solution by code, business field, region, phase, or evidence level.

<div id="dteg-solutions-explorer"></div>

**Finding a solution again.** This guide is long enough that the fastest way back to a specific solution is your document viewer's search function (Ctrl+F / Cmd+F) on its code — every mention uses the same code consistently. If you only want the solutions with the deepest case-study material, search for S1, S9, P2, P4, P5, or P7: these recur across Section 4 and Section 5 as worked examples, not just this table. The filters above give you the same result without leaving the page.

### 2.2.1 Socio-Economic Realities

The businesses involved in the DTEG project spanned retail, food processing, agricultural trading, crop e-commerce, inventory management, service provision, and manufacturing. Income streams were often irregular and cash-based. Many participants managed both business and household finances from the same pool of money, which made any financial tool with subscription fees or complex pricing a difficult proposition.
...
Caregiving and domestic responsibilities also shape adoption directly, not just as background context. Solution P2's testing surfaced this starkly in a comparison between two participants with the same underlying problem: *"The men can go to town and find help. But I have children to care for and cooking to do. I cannot leave my home for a whole day to chase a vet."* A design or service model that assumes a user can freely travel or step away is, in practice, assuming away a constraint that falls disproportionately on women in this user group. Phone access itself can be gendered within a household — Solution P2's team also found that some women farmers shared a phone with a husband or older child, which shaped who could act on a time-sensitive notification and when.
...
!!! quote "Field observation — Intermediary N1 + Solution S1 (Tamale, 2025)."
    During initial user testing, the password setup on Solution S1 was causing login failures before participants had even seen the app's core features. Once simplified, a validation participant put it plainly: *"This time I got in within less than a minute."* (The full co-creation cycle behind this fix, and why it became this guide's model for writing evidence-backed recommendations, is in Section 4, Part A, Step 3.)

### 2.2.3 Digital Literacy and Business Acumen

The participant cohorts in the DTEG project showed a wide range of digital experience. Among Intermediary N1's group in Tamale, 60 percent had basic or secondary school education, 30 percent had tertiary qualifications, and 10 percent had postgraduate qualifications. Digital literacy did not map neatly onto formal education: some participants with secondary schooling were confident mobile money users, while some with higher qualifications had very limited app experience.
...
!!! quote "Field observation — Intermediary A1 + Solution S9 (Ashanti Region, 2025)."
    Intermediary A1's validation of Solution S9 platform found that mobile-number-based login was successfully completed by all participants. However, 61.5% of participants needed assistance during initial sign-up, and the inventory update task had a 36.4% failure rate. Font and icon sizes were repeatedly flagged as too small, particularly for older participants. Five participants specifically requested voice features to guide them through key workflows. *"Confused about the interface"* and *"Saw lots of options so I got confused"* were the most common responses from participants encountering the platform for the first time.
...
### 2.2.4 Environmental and Operational Context
...
### 2.2.5 Trust, Perceived Value, and Safety

Trust has to be earned before a solution can be adopted. Participants in the DTEG project were generally cautious about apps that asked for personal data, financial information, or access to contacts without explaining why. Intermediary N2 found that building trust through transparent communication about security, data privacy, and fraud protection was as important as the functional design of the solution.

!!! quote ""
    *"With the provision of available customer reps to help me, I no longer feel intimidated by the app in any way."* — Validation participant, Solution S1, Tamale, 2025.
